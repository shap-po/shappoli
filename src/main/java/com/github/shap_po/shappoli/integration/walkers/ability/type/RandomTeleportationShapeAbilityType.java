...
public class RandomTeleportationShapeAbilityType extends ShapeAbilityType {
    private final RandomTeleportationAbility<LivingEntity> ability = new RandomTeleportationAbility<>();
    ...
    public @NotNull ActionConfiguration<?> getConfig() {
        return ShapeAbilityTypes.RANDOM_TELEPORTATION;
    }
}
