...
public class ShootDragonFireballShapeAbilityType extends ShapeAbilityType {
    private final ShootDragonFireball<LivingEntity> ability = new ShootDragonFireball<>();
    ...
    public @NotNull ActionConfiguration<?> getConfig() {
        return ShapeAbilityTypes.SHOOT_DRAGON_FIREBALL;
    }
}
