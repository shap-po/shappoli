...
public class LlamaShapeAbilityType extends ShapeAbilityType {
    private final LlamaAbility<LivingEntity> ability = new LlamaAbility<>();
    ...
    public @NotNull ActionConfiguration<?> getConfig() {
        return ShapeAbilityTypes.LLAMA;
    }
}
