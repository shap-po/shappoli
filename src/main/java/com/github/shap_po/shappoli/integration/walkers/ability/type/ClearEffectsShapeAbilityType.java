...
public class ClearEffectsShapeAbilityType extends ShapeAbilityType {
    private final ClearEffectsAbility<LivingEntity> ability = new ClearEffectsAbility<>();
    ...
    public @NotNull ActionConfiguration<?> getConfig() {
        return ShapeAbilityTypes.CLEAR_EFFECTS;
    }
}
