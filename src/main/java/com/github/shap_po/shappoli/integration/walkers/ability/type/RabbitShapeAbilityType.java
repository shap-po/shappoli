...
public class RabbitShapeAbilityType extends ShapeAbilityType {
    private final RabbitAbility<LivingEntity> ability = new RabbitAbility<>();
    ...
    public @NotNull ActionConfiguration<?> getConfig() {
        return ShapeAbilityTypes.RABBIT;
    }
}
