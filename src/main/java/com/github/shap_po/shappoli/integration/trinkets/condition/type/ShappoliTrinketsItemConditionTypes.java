...
import com.github.shap_po.shappoli.integration.trinkets.condition.type.item.*;
...
public class ShappoliTrinketsItemConditionTypes {
    ...
    public static final ConditionConfiguration<HasTrinketPowerItemConditionType> HAS_TRINKET_POWER = ItemConditionTypes.register(ConditionConfiguration.of(Shappoli.identifier("has_trinket_power"), HasTrinketPowerItemConditionType.DATA_FACTORY));
