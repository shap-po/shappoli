...
public class ReceiveConditionPowerType extends PowerType {
    ...
    public ReceiveConditionPowerType(Power type, LivingEntity entity, Predicate<Pair<Entity, Entity>> bientityCondition, Predicate<Entity> entityCondition, Predicate<Pair<World, ItemStack>> itemCondition) {
        super(type, entity);
