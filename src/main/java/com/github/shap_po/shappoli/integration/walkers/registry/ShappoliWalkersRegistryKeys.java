...
public class ShappoliWalkersRegistryKeys {
    public static final RegistryKey<Registry<Class<? extends ShapeAbility<?>>>> SHAPE_ABILITY_CLASS = create("shape_ability_class");
    public static final RegistryKey<Registry<ActionConfiguration<ShapeAbilityType>>> SHAPE_ABILITY_TYPE = create("shape_ability_type");
